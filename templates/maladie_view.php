    ...
    <div class="container py-5">
        ...
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a class="text-white" href="index.php?action=maladie">Maladie et épidémie</a></li>
...
<div class="container">
    <div class="row">
        <div class="col-lg-8 col-md-12">
            ...
            <p><img class="img-fluid w-100" src="<?= $maladie->photoMal; ?>" alt=""></p>
            <p class="fs-5 mt-5">
                <?= nl2br($maladie->descMal); ?>
            </p>
        </div>
