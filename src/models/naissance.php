...
class naissanceRepository
{
    ...
    public function createNaissanceAttente(string $nomEnf, string $prenomEnf, string $sexe, string $dateNais, string $modeNais, string $nomPere, string $prenomPere, $nomMere, $prenomMere, $lieuHab)
    {
        $statement = $this->connection->getConnection()->prepare('INSERT INTO naissance_attente(nom_enf, pren_enf, sexe_enf, date_nais_enf, mode_nais, nom_pere,  pren_pere, nom_mere, pren_mere, lieu_hab_enf) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
