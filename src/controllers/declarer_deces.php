<?php
namespace Application\Controllers\DeclarerDeces;
...
class DeclarerDeces
{
    public function execute()
    {
        ...
        $success = $decesRepository->createDecesAttente($nomDec, $prenomDec, $sexe, $dateNais, $dateDec, $lieuDec, $causeDec, $nomParent, $prenomParent, $lieuHabDec, $fonctDec);
