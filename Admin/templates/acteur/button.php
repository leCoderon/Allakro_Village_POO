<!-- eiditer article -->
<div class="modal fade" id="edit<?= $acteur->idAct ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <form method="post" action="index.php?action=acteur/modifier_acteur&id=<?= $acteur->idAct ?>">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="nom" id="titre"
                                            placeholder="Titre de l'actualité" value="<?= $acteur->nomAct ?>" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="prenom" id="titre"
                                            placeholder="Titre de l'actualité" value="<?= $acteur->prenAct ?>"  required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="civilite" id="Catégorie"
                                            placeholder="Catégorie" value="<?= $acteur->civAct ?>"  required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        value="<?= $acteur->dateNais ?>"  required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        value="<?= $acteur->sexe ?>"  required>
                                        <label for="date">Sexe (M/F)</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email" class="form-control" name="email" id="date" placeholder="date"
                                        value="<?= $acteur->email ?>"   required>
                                        <label for="date">Email</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="enfant" id="date" placeholder="date"
                                        value="<?= $acteur->nbrEnf ?>"  required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="numero" id="date" placeholder="date"
                                        value="<?= $acteur->tel ?>"  required>
...
<!-- Supprimer article -->
<div class="modal fade" id="delete<?= $acteur->idAct ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <a href="index.php?action=acteur/suprimer_acteur&id=<?= $acteur->idAct ?>"
