<!-- eiditer article -->
<div class="modal fade" id="edit<?= $dece->idDec ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- form -->
                <form method="post" action="index.php?action=deces/modifier_deces&id=<?= $dece->idDec; ?>">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="nomDec" id="nom"
                                        placeholder="Nom du défunt" value="<?= $dece->nomDec ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="prenomDec" id="prenom"
                                        placeholder="prénom du défunt" value="<?= $dece->prenDec ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="sexe" name="sexeDec"
                                        placeholder="sexe du défunt (Fille/Garçon)" value="<?= $dece->sexDec ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="date" class="form-control" name="dateNaisDec" id="date"
                                        placeholder="Date de naissance du défunt" value="<?= $dece->dateNaisDec ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="date" class="form-control" name="dateDec" id="date"
                                        placeholder="date de décès du défunt" value="<?= $dece->dateDec ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="causeDec" id="cause"
                                        placeholder="lieu de décès du défunt" value="<?= $dece->causeDec ?>" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="lieuDec" id="lieu"
                                        placeholder="lieu de décès du défunt" value="<?= $dece->lieuDec ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="nomParent" nomMere id="nomp"
                                        placeholder="Nom parent du défunt" value="<?= $dece->nomParent ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="prenomParent" id="prenomp"
                                        placeholder="prénom du parent du défunt" value="<?= $dece->prenParent ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="lieuHabDec" id="lieu"
                                        placeholder="Lieu de résidence du défunt" value="<?= $dece->lieuHabDec ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="fonctDec" id="fonct"
                                        placeholder="Fonctiosexen du défunt" value="<?= $dece->fonctDec ?>" required>
...
<!-- Supprimer article -->
<div class="modal fade" id="delete<?= $dece->idDec ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <a href="index.php?action=deces/suprimer_deces&id=<?= $dece->idDec ?>"
