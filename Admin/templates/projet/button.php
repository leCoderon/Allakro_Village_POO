<!-- eiditer article -->
<div class="modal fade" id="edit<?= $projet->idProj ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 py-4">
                        ...
                        <form method="post" action="index.php?action=projet/modifier_projet&id=<?= $projet->idProj ?>">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="nom" id="titre"
                                            placeholder="Titre de la pharmacie" value="<?= $projet->nomProj ?>" required>
                                        <label for="titre">Nom du projetx</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="auteur" id="Catégorie"
                                            placeholder="Catégorie" value="<?= $projet->auteur ?>" required>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" name="description" placeholder="Descrption"
                                            id="Descrption" style="height: 100px" required><?= $projet->descProj ?></textarea>
...
<!-- Supprimer article -->
<div class="modal fade" id="delete<?= $projet->idProj ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <a href="index.php?action=projet/suprimer_projet&id=<?= $projet->idProj ?>"
