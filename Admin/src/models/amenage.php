...
class AmenageRepository
{
    ...
    public function getAmenages(): array
    {
    ...
    public function updateAmenage($nom, $prenom, $sexe, $dateNais, $provenance, $mode, $domicile, $fonction, $id): bool
    {
    ...
    public function deleteAmenage($id)
    {
