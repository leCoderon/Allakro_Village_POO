...
class DecesRepository
{
    ...
    public function updateDeces($nomDec, $prenomDec, $sexe, $dateNais, $dateDec, $lieuDec, $causeDec, $nomParent, $prenomParent, $lieuHabDec, $fonctDec, $id): bool
    {
    ...
    public function deleteDeces($id)
    {
        ...
        $statement = $this->connection->getConnection()->prepare('DELETE FROM deces WHERE id_dec=?');
        $statement->execute([$id]);
    }
}