...
class ModifierCentre
{
    public function execute()
    {
        $nomCentre = null;
        $descCentre = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis perspiciatis earum aperiam fuga sint error explicabo animi consequuntur ex. Id reprehenderit sapiente vitae. Beatae corrupti cupiditate, saepe maiores vero delectus!
        ';
        $photoCentre = null;
        $localisation = null;
        $service = null;
        ...
        $success = $CentreSanteRepository->updateCentre($nomCentre, $localisation, $service, $descCentre, $photoCentre, $id);
