...
class ModifierNaissance
{
    public function execute()
    {
        ...
        $success = $NaissanceRepository->updateNaissance($nomEnf, $prenomEnf, $sexe, $dateNais, $modeNais, $nomPere, $prenomPere, $nomMere, $prenomMere, $lieuHab, $id);
