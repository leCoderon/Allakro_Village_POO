<?php
// require('src/models/naissance.php');
...
// $success = $NaissanceRepository->createNaissance($nomEnf, $prenomEnf, $sexe, $dateNais, $modeNais, $nomPere, $prenomPere, $nomMere, $prenomMere, $lieuHab);

// if (!$success) {
//     throw new \Exception('Impossible de déclarer cette naissance !');
// } else {
//     header('Location: index.php?action=succes&destination=naissance/naissance');}